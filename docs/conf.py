...
htmlhelp_basename = "ledgerethdoc"
...
latex_documents = [
    (master_doc, "ledgereth.tex", "ledgereth Documentation", "Mike Shultz", "manual"),
]
...
man_pages = [(master_doc, "ledgereth", "ledgereth Documentation", [author], 1)]
